        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublihDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    PublishHouseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Items_Librarys_libraryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoandedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoandBook", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoandBook_Items_BookItemId",
                        column: x => x.BookItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LoandBook_Users_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoandBook_BookItemId",
                table: "LoandBook",
                column: "BookItemId");

            migrationBuilder.CreateIndex(
                name: "IX_LoandBook_MemberId",
                table: "LoandBook",
                column: "MemberId");
        }
